...
public interface IGT_RecipeAdder {
    ...
    boolean addCompressorRecipe(ItemStack aCircuit, FluidStack aOutput, int aDuration, int aEUt);
    ...
    boolean addOreWasherRecipe(ItemStack aInput, ItemStack aOutput1, ItemStack aOutput2, ItemStack aOutput3, FluidStack aFluidInput, FluidStack aFluidOutput, int aDuration, int aEUt);

    boolean addOreWasherRecipe(ItemStack aInput1, ItemStack aInput2, ItemStack aOutput1, ItemStack aOutput2, ItemStack aOutput3, FluidStack aFluidInput, FluidStack aFluidOutput, int aDuration, int aEUt);
    ...
    boolean addAutoclaveRecipe(ItemStack aInput1, ItemStack aInput2, FluidStack aInputFluid, ItemStack aOutput, FluidStack aOutputFluid, int aChance, int aDuration, int aEUt);
    ...
    boolean addDisassemblerRecipe(ItemStack aInput, ItemStack[] aOutputs, int aDuration, int aEUt);

    boolean addFilterRecipe(FluidStack aInput, FluidStack aOutput, ItemStack[] aOutputs, int aDuration, int aEUt);

    boolean addReplicatorRecipe(ItemStack aInput, ItemStack aOutput, boolean aMetaGeneratedItem, int aScanDuration, int aScanEUt, int aMatterAmount, int aReplicationDuration, int aReplicationEUt);
     ...
     * Currently only affects Chemical Reactor Recipes.
     */
    void setIsAddingDeprecatedRecipes(boolean isAddingDeprecatedRecipes);
