...
public class GT_TileEntity_Ores extends TileEntity implements ITexturedTileEntity {
    ...
    public ITexture[] getTexture(Block aBlock, byte aSide) {
        ...
        return new ITexture[]{new GT_CopiedBlockTexture(Blocks.stone, 0, 0), new GT_RenderedTexture(gregtech.api.enums.TextureSet.MATERIALS.mTextures[OrePrefixes.ore.mTextureIndex])};
    }
}
